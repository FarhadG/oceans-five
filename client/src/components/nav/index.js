...
const NavHead = (props) => (
  <header className="nav-head">
    <Link to="/">
      <strong className="h4 text-uppercase">Ocean's 5</strong>
    </Link>
...
class NavList extends Component {
  ...
  handleClick = (index, e) => {
    ...
    this.setState({
      selected: (~c.indexOf('selected')) ? '' : index
    });
  };
  ...
  render() {
    return <ScrollArea className="nav-list-container" horizontal={false}
      ...
      <ul className="list-unstyled nav-list clearfix">
        ...
        {/*&emsp;<span className="badge text-uppercase"*/}
        {/*style={{ 'background': '#7C4DFF' }}>10</span>*/}
        {/*</Link>*/}
        {/*</li>*/}
        ...
        {/*</Link>*/}
        {/*<Collapse isOpen={this.state.selected === 3 ? true : false}*/}
        ...
        {/*<IconDown size="14" className="icon-down" />*/}
        {/*</Link>*/}
        {/*<Collapse isOpen={(this.state.selected === 4) ? true : false}*/}
        ...
        {/*<IconDown size="14" className="icon-down" />*/}
        {/*</Link>*/}
        {/*<Collapse isOpen={(this.state.selected === 7) ? true : false}*/}
